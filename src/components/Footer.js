        ...
        <div style={{ position: "relative", height: "auto", backgroundColor: "#005B9A", marginBottom: "0px", fontFamily: "comic sans" }}>
            <Row style={{ padding: "10px 0px" }}>
                <Col sm={6} md={2} style={{ padding: "5px" }}>
                    <SocialIcon url="https://www.instagram.com/code_with_vic/" bgColor="#74C2E1" fgColor="white" />
                </Col>
                <Col sm={6} md={2} style={{ padding: "5px" }}>
                ...
                <Col sm={6} md={2} style={{ padding: "5px" }}>
                    <SocialIcon url="https://www.facebook.com/YTCodeWithVic/" bgColor="#74C2E1" fgColor="white" />
                </Col>
                <Col sm={6} md={2} style={{ padding: "5px" }}>
                    <SocialIcon url="https://www.linkedin.com/in/vikrant-bhat-2b6221189/" bgColor="#74C2E1" fgColor="white" />
                </Col>
            </Row>
        </div>
    );
